...
<html lang="ko">
    ...
    fwrite($f, $temp. " " .$tp." ".$lang." ".$useragent." ".$refe."\n"); fclose($f);
    ...
    <body>
        <div data-role="page">
            ...
            <div data-role="content">
                <p>이 페이지에 접근하려면 사전에 공유된 인증코드로 인증하세요.</p>
                <input type="password" name="password_key" id="password_key" class="password_key" placeholder="이 곳에 인증코드를 입력하세요." autofocus>
                <button type="button" id="button" class="submit" onClick="admin_page_join()">접속</button>
            </div>
        </div>
    <?php
    } else {
